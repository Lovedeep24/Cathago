...
async function getUserStats(){
    ...
    try {
        const response = await fetch('https://docscanner-jsd8.onrender.com/analytics',{
            method: "GET",
            headers: {
...
async function fetchTopUsers() {
    const token=localStorage.getItem("token");
    try {
        const response = await fetch('https://docscanner-jsd8.onrender.com/topusers',{
            method: "GET",
            headers: {
                "Authorization": `Bearer ${token}`,
                "Content-Type": "application/json"
...
async function fetchTopTopics() {
    const token=localStorage.getItem("token");
    try {
        const response = await fetch('https://docscanner-jsd8.onrender.com/topic',{
            method:"GET",
            headers: {
                "Authorization": `Bearer ${token}`,
                "Content-Type": "application/json"
...
async function fetchUserRequests() {
    const token=localStorage.getItem("token");
    try {
        const response = await fetch('https://docscanner-jsd8.onrender.com/getcreditrequest',{
            headers: {
                "Authorization": `Bearer ${token}`,
                "Content-Type": "application/json"
            }
...
try {
    ...
    const response=await fetch(`https://docscanner-jsd8.onrender.com/approve/${userId}`, {
        method: 'PATCH',
        headers: {
            "Authorization": `Bearer ${token}`,
            "Content-Type": "application/json"
...
async function rejectUser(userId) {
    const token=localStorage.getItem("token");
    try {
        const response=await fetch(`https://docscanner-jsd8.onrender.com/decline/${userId}`, {
            method: 'PATCH',
            headers: {
                "Authorization": `Bearer ${token}`,
                "Content-Type": "application/json"
