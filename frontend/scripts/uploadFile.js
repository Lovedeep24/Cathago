...
async function fetchUserDetails(){
    ...
    try {
        const response = await fetch(`https://docscanner-jsd8.onrender.com/userprofile/${userId}`,{
            method: 'GET',
            headers: {
...
async function handleCreditReq()
{
    ...
    try {
        ...
        const response = await fetch(`https://docscanner-jsd8.onrender.com/creditRequest/${userId}`,{
            method: 'PATCH',
            headers: {
                "Authorization": `Bearer ${token}`,
                "Content-Type": "application/json"
...
async function handleScan(){
    ...
    const response = await fetch(`https://docscanner-jsd8.onrender.com/match/${docId}/${userId}`,{
        method: 'GET',
        headers: {
            "Authorization": `Bearer ${token}`,
            "Content-Type": "application/json"
...
async function uploadFile() {
   ...
   const response = await fetch('https://docscanner-jsd8.onrender.com/upload',{
       method:"POST",
